...
export const COMPANION_SERVICES = [
  ...
  {
    offer: 26, name: "Generator Content - RevShare", slug: "generator-content-revshare", type: "content",
  ...
  {
    offer: 27, name: "Generator Content - PPS", slug: "generator-content-pps", type: "content",
  ...
  {
    offer: 28, name: "Harder Platform", slug: "harder-platform", type: "wellness",
  ...
  {
    offer: 29, name: "Joi Assistant - Type A", slug: "joi-assistant-type-a", type: "companion",
  ...
  {
    offer: 30, name: "Joi Assistant - Tier 1 Pro", slug: "joi-assistant-tier-1-pro", type: "companion",
  ...
  {
    offer: 31, name: "Joi Assistant - Lifetime", slug: "joi-assistant-lifetime", type: "companion",
  ...
  {
    offer: 32, name: "Kupid AI - PPS", slug: "kupid-ai-pps", type: "companion",
  ...
  {
    offer: 33, name: "Kupid AI - RevShare", slug: "kupid-ai-revshare", type: "companion",
  ...
  {
    offer: 34, name: "Lovel Platform", slug: "lovel-platform", type: "companion",
  ...
  {
    offer: 35, name: "Lovescape - Type A", slug: "lovescape-type-a", type: "companion",
    rating: 4.5, popularity: 82, price: "Бесплатный старт / Pro от $12 в мес.",
  ...
  {
    offer: 36, name: "Lovescape - RevShare", slug: "lovescape-revshare", type: "companion",
  ...
  {
    offer: 37, name: "Lusy Chat Platform", slug: "lusy-chat-platform", type: "companion",
  ...
  {
    offer: 38, name: "MyLovely AI - Type A", slug: "mylovely-ai-type-a", type: "companion",
  ...
  {
    offer: 39, name: "MyLovely AI - Revenue", slug: "mylovely-ai-revenue", type: "companion",
  ...
  {
    offer: 40, name: "Ourdream AI - Type A", slug: "ourdream-ai-type-a", type: "companion",
  ...
  {
    offer: 41, name: "Ourdream AI - Pro", slug: "ourdream-ai-pro", type: "companion",
  ...
  {
    offer: 42, name: "Ourdream AI - Revenue", slug: "ourdream-ai-revenue", type: "companion",
  ...
  {
    offer: 43, name: "Ourdream AI - H Content", slug: "ourdream-ai-h-content", type: "content",
  ...
  {
    offer: 44, name: "Promptchan Platform", slug: "promptchan-platform", type: "content",
  ...
  {
    offer: 45, name: "Secure AI - Lifetime", slug: "secure-ai-lifetime", type: "companion",
  ...
  {
    offer: 46, name: "Multi-CPA Network 2", slug: "multi-cpa-network-2", type: "smartlink",
  ...
  {
    offer: 47, name: "Swipey Platform", slug: "swipey-platform", type: "companion",
  ...
  {
    offer: 48, name: "Xotic AI - Type A", slug: "xotic-ai-type-a", type: "companion",
  ...
  {
    offer: 49, name: "Xotic AI - Revenue", slug: "xotic-ai-revenue", type: "companion",
  ...
  {
    offer: 50, name: "CrakRevenue Bonus Link", slug: "crakrevenue-bonus-link", type: "smartlink",
